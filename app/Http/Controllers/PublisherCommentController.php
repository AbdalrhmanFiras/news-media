...
use App\Http\Requests\StorePublisherCommentRequest;
use App\Http\Requests\UpdatePublisherCommentRequest;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class PublisherCommentController extends Controller
{
    use ApiResponse;

    public function store(StorePublisherCommentRequest $request, $postId)
    {
        try {
            $user = Auth::user();
    ...
    public function update(UpdatePublisherCommentRequest $request, $postId, $commentId)
    {
        try {
            $userId = Auth::id();
            $data = $request->validated();
